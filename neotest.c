...
- Check if env shows you the current environment variables
	...
	1) env
	2) "env"
	3) env sdfg --> Erreur ? Env prend des argument visiblement */
...
- Check them with env
	...
	2) export A
	3) export A B C
	4) export A= B= C= --> ERREUR (si on run export A B C avant) car non mise à jour dans ENV !
	5) export A=AAA B=BBB C=CCC
	6) export =
	7) export ;
	8) export _ --> Erreur : empêcher d'export juste le _ ?
	9) export 1
	10) export -1 */
